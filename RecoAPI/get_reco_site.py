...
(venv_RecoAPI) [ec2-user@ip-172-31-36-216 RecoAPI]$ ls
get_reco_site.py    reco.py    save_dont_track_url.py  settings.py
make_reco_model.py  reco.wsgi  save_in_s3.py
(venv_RecoAPI) [ec2-user@ip-172-31-36-216 RecoAPI]$ cat get_reco_site.py 
